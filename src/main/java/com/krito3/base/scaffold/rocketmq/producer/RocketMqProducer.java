package com.krito3.base.scaffold.rocketmq.producer;
...
public class RocketMqProducer {
    ...
    public <T> SendResult sendMsg(String topic, T msg) {
        ...
        log.info("【sendMsg】sendResult={}", JSONUtil.toJsonStr(sendResult));
        return sendResult;
    }
     ...
     * 可通过修改broker服务broker.conf配置来修改固定等级所代表的时间或者等待rocketmq 5.0新特性支持
     * 延迟的底层方法是用定时任务实现的。
    ...
    public <T> void sendDelay(String topic, T msg, long timeout, int delayLevel) {
        ...
        log.info("发送延时消息：message:{}", message);
    }
